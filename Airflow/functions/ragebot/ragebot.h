...
struct point_t {
	...
	int			hitbox = -1;
	int			priority_level = priority_lowest;
	int			damage{};
	...
	__forceinline void reset() {
		...
		hitbox = -1;
		priority_level = priority_lowest;
		damage = 0;
...
private:
	...
	std::array< vector3d, 12 > knife_ang{
		vector3d{ 0.f, 0.f, 0.f }, vector3d{ 0.f, -90.f, 0.f }, vector3d{ 0.f, 90.f, 0.f }, vector3d{ 0.f, 180.f, 0.f },
		vector3d{ -80.f, 0.f, 0.f }, vector3d{ -80.f, -90.f, 0.f }, vector3d{ -80.f, 90.f, 0.f }, vector3d{ -80.f, 180.f, 0.f },
		vector3d{ 80.f, 0.f, 0.f }, vector3d{ 80.f, -90.f, 0.f }, vector3d{ 80.f, 90.f, 0.f }, vector3d{ 80.f, 180.f, 0.f }
	};
...
public:
	...
	__forceinline bool can_dt() {
		return g_cfg.binds[dt_b].toggled
			&& g_ctx.weapon->item_definition_index() != weapon_awp
			&& g_ctx.weapon->item_definition_index() != weapon_ssg08;
	}
};