...
void c_chams::on_draw_model_execute(draw_model_execute_fn original, void* ecx, void* edx, void* ctx,
	...
	if (interfaces::client_state->delta_tick == -1 || interfaces::studio_render->is_forced_material_override() || !this->should_draw())
