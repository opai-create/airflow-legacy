...
struct configs_t {
	...
	struct misc_t {
		...
		c_float_color trace_clr[3] = {
			c_float_color(245, 66, 66),
			c_float_color(66, 164, 245),
			c_float_color(191, 66, 245)
		};
		...
		c_float_color world_clr[4] {
			c_float_color(13, 13, 21),
			c_float_color(92, 98, 161),
			c_float_color(147, 135, 222),
			c_float_color(149, 149, 180)
		};
		...
		c_float_color ui_color{ 150, 113, 220 };
	}misc;
