...
class c_base_trace {
public:
    __forceinline bool is_disp_surface() { return ((disp_flags & dispsurf_flag_surface) != 0); }
    __forceinline bool is_disp_surface_walkable() { return ((disp_flags & dispsurf_flag_walkable) != 0); }
    __forceinline bool is_disp_surface_buildable() { return ((disp_flags & dispsurf_flag_buildable) != 0); }
    __forceinline bool is_disp_surface_prop1() { return ((disp_flags & dispsurf_flag_surfprop1) != 0); }
    __forceinline bool is_disp_surface_prop2() { return ((disp_flags & dispsurf_flag_surfprop2) != 0); }
