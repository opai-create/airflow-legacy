...
namespace modules {
	...
	__forceinline void init() {
		client				= LI_FN(GetModuleHandleA)(xor_c_s("client.dll"));
		server				= LI_FN(GetModuleHandleA)(xor_c_s("server.dll"));
		engine				= LI_FN(GetModuleHandleA)(xor_c_s("engine.dll"));
		materialsystem		= LI_FN(GetModuleHandleA)(xor_c_s("materialsystem.dll"));
		tier0				= LI_FN(GetModuleHandleA)(xor_c_s("tier0.dll"));
		shaderapidx9		= LI_FN(GetModuleHandleA)(xor_c_s("shaderapidx9.dll"));
		vgui2				= LI_FN(GetModuleHandleA)(xor_c_s("vgui2.dll"));
		inputsystem			= LI_FN(GetModuleHandleA)(xor_c_s("inputsystem.dll"));
		vstdlib				= LI_FN(GetModuleHandleA)(xor_c_s("vstdlib.dll"));
		localize			= LI_FN(GetModuleHandleA)(xor_c_s("localize.dll"));
		datacache			= LI_FN(GetModuleHandleA)(xor_c_s("datacache.dll"));
		studiorender		= LI_FN(GetModuleHandleA)(xor_c_s("studiorender.dll"));
		vguimatsurface		= LI_FN(GetModuleHandleA)(xor_c_s("vguimatsurface.dll"));
		vphysics			= LI_FN(GetModuleHandleA)(xor_c_s("vphysics.dll"));
		gameoverlayrenderer = LI_FN(GetModuleHandleA)(xor_c_s("gameoverlayrenderer.dll"));
	}
}
...
namespace patterns {
	...
	__forceinline void init() {
		...
		build_transformations				= g_memory->find_pattern(modules::client, xor_c_s("55 8B EC 83 E4 F0 81 EC ? ? ? ? 56 57 8B F9 8B 0D ? ? ? ? 89 7C 24 28 8B"));
