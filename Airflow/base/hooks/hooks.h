...
// model render
using draw_model_execute_fn = void(__thiscall*)(void*, void*,
	const draw_model_state_t&, const model_render_info_t&, matrix3x4_t*);
...
using present_fn = HRESULT(__stdcall*)(IDirect3DDevice9*, const RECT*, const RECT*,
	HWND, const RGNDATA*);
...
namespace tr {
	...
	namespace studio_render {
		extern void __fastcall draw_model(c_studio_render* ecx, void* edx, void* results, const draw_model_info_t& info,
			matrix3x4_t* bone_to_world, float* flex_weights, float* flex_delayed_weights, const vector3d& model_origin, int flags);

		extern void __fastcall draw_model_array(void* ecx, void* edx,
	...
	namespace model_render {
		extern void __fastcall draw_model_execute(void* ecx, void* edx, void* ctx,
			const draw_model_state_t& state, const model_render_info_t& info, matrix3x4_t* bone_to_world);
	}
	...
	namespace player {
		...
		extern void __fastcall standard_blending_rules(c_csplayer* ecx, void* edx, c_studiohdr* hdr,
		...
		extern void __fastcall do_extra_bone_processing(c_csplayer* ecx, void* edx, c_studiohdr* hdr,
	...
	namespace direct {
		extern HRESULT __stdcall present(IDirect3DDevice9* device, const RECT* src_rect, const RECT* dest_rect,
